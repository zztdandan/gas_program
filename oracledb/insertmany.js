...
async function insert_many(tablename,manyArray,proc){
  let conn;
  let result;
  ...
  try{
    ...
    const insertSql = "INSERT INTO "+tablename+" values (to_date(replace(:real_time,\'T\',\' \'), 'YYYY-MM-DD HH24:MI:SS'), :prop,:prop_cname,:value,'"+proc+"')";
